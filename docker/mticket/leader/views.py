        ...
        if request.session['leader'] != 'mbf':
            ...
            for tk in tksdpr:
                if tk.status == 0:
                    status = r'<span class ="label label-danger" id="leader' + str(tk.id) + '">Chờ</span>'
                    handler = '<p id="hd' + str(tk.id) + '">Nobody</p>'
                    option = r'''<button disabled class="btn btn-default"><i class="fa fa-power-off"></i></button>
                            <button disabled class="btn btn-default" ><i class="fa fa-trash-o"></i></button>
                            <button disabled class="btn btn-default" ><i class="fa fa-share-square-o" ></i></button>
                            <button disabled class="btn btn-default"><i class="fa fa-arrow-right" ></i></button>'''
